          ...
          <div>
                ...
                <h2 className="max-w-4xl text-start text-gray-600 dark:text-white">An Amazing frontend developer and technical writer with a passion 
                    ...
                    <div className="resume xl:hidden">
                      <a href={resume} download='resume' className=' text-gray-600 dark:text-white dark:border-white hover:text-white hover:border-red-400 border-2 border-gray-700 px-2 lg:px-10 py-2 lg:py-3 rounded-sm hover:bg-red-400 shadow-lg'>Download resume</a>
                     </div>
        </div>
       </div>
       <div>
         <footer >
            <Link className="hover:text-gray-600 text-lg lg:text-4xl rounded-full py-2 bg-red-400 text-white"  to='reviews'>Technical Reviews</Link>
        </footer>
       </div>
     </div>
     );
